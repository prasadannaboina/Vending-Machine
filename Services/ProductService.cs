...
namespace VendingMachine
{
    ...
    {
        private readonly IProductData _productRepository;
        private readonly IProductInventoryData _productInventoryRepository;
        public ProductService(IProductData productRepository, IProductInventoryData productInventoryRepository)
        {
